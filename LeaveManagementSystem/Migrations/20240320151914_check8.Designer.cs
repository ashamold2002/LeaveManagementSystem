...
namespace LeaveManagementSystem.Migrations
{
    ...
    [Migration("20240320151914_check8")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeaveManagementSystem.Models.LeaveAllocated", b =>
                {
                    ...
                    b.Property<int>("OnDutyDetailsId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LeaveManagementSystem.Models.OnDutyDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LeaveManagementSystem.Models.LeaveAllocated", b =>
                {
                    ...
                    b.HasOne("LeaveManagementSystem.Models.OnDutyDetails", "OnDutyDetails")
                        .WithMany()
                        .HasForeignKey("OnDutyDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("EmployeeDetails");

                    b.Navigation("OnDutyDetails");
                });
